...
// 2. Look up
DataSource ds = (DataSource) ic.lookup("java:comp/env/jdbc/orcl");
...
JDBC의 이러한 단점을 극복하고 장점은 유지하기위해 Spring의 JDBC는 반복적으로 처리해야하는 작업들을 JDBC Template등을 통해 대신 수행해주며, 이외에도 기존의 JDBC보다 편리한 기능들을 제공한다.
